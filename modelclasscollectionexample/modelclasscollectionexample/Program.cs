...
using modelclasscollectionexample;
...
namespace ModelClassCollectionList
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            MMC.MemberId = 1;
            MMC.MemberFirstName = "Atul";
            MMC.MemberLastName = "Saigal";
            MMC.MemberContactNo = "9862475316";
            MMC.MemberEmailId = "Atulsaigal@gmail.com";
            MMC.MemberGender = 'M';
